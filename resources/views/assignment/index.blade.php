                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-center">
                            ...
                            @if (auth()->user()->role->name == 'Student')
                            @if ( strtotime($assignment->end_time) > time()) <button type="button"
                                class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#submit">
                                Add Submission
                            </button>
                            @endif
                            ...
                            <a href="{{ route('assignment.show', $assignment) }}" class="btn btn-primary text-white">
                                Show Detail
                            </a>
                            @endif
                        </td>
            ...
            <div class="modal-body">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            @foreach($assignment->submissionUser as $submission)
                            <tr>
                                <td class="align-middle text-center">{{ $index+1 }}</td>
